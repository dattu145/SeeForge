...
const Templates = () => {
  ...
  const getDemoTemplates = () => [
    ...
    },
    {
      id: '5',
      name: 'Education LMS',
      description: 'Learning management system with courses and student tracking',
      category: 'education',
      preview_image: 'https://images.unsplash.com/photo-1501504905252-473c47e087f8?w=800',
      features: ['Course Management', 'Video Lessons', 'Quizzes', 'Progress Tracking'],
    ...
    },
    {
      ...
      category: 'saas',
      preview_image: 'https://images.unsplash.com/photo-1506784365847-bbad939e9335?w=800',
      features: ['Calendar Booking', 'Payment Processing', 'Email Notifications', 'User Profiles'],
      tech_stack: { frontend: 'React + TypeScript', backend: 'Node.js + Stripe' },
      estimated_build_time: '2-3 weeks',
      base_price: 7000
    }
  ];
          ...
          {loading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredTemplates.map((template) => (
                <div key={template.id} className="card overflow-hidden" data-testid={`template-${template.id}`}>
                  ...
                  <div className="space-y-3 mb-4">
                    <div>
                      <p className="text-sm text-[#94A3B8] mb-2">Key Features:</p>
